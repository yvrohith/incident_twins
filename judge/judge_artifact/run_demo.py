"""Replay saved examples; expected answers never enter investigator subprocesses."""
import argparse
...
spec = json.loads((root / 'expected' / 'results.json').read_bytes())
records = []
...
summary = {'scope': 'Saved JSON and packaging replay only; no framework or worker experiments regenerated',
